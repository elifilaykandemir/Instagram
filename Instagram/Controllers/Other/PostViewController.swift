        ...
        StorageManager.shared.profilePictureURL(for: username) { [weak self] profilePictureURL in
            ...
            DatabaseManager.shared.getComments(
                ...
                var postData: [SinglePostCellType] = [
                    ...
                    .actions(viewModel: PostActionCollectionViewCellViewModel(isLiked: isLiked)),
...
extension PostViewController: PostActionCollectionViewCellDelegate {
    ...
    func postActionsCollectionViewCellDidTapLike(
        _ cell: PostActionCollectionViewCell,
        isLiked: Bool,
        index: Int) {
